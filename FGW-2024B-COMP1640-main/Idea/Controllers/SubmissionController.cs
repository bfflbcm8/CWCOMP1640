    ...
    public class SubmissionController : Controller
    {
        ...
        public async Task<IActionResult> AddIdea(NIdea nIdea, IFormFile file, bool isAcceptTerms)
        {
            ...
            if (isAcceptTerms)
            {
                ...
                //submission.Deadline_1 >= DateTime.Now( end 2 deadline1, deadline2 not submission)
        ...
        public async void SendEmail(string userId, string content, string subject)
        {
            ...
            //user send mail
            MailboxAddress from = new MailboxAddress("First Great Western Idea Management System", "liamchau3006@gmail.com");
            //user get mail MailboxAddress to = new MailboxAddress(user.UserName, user.Email);
            MailboxAddress to = new MailboxAddress("Chau", "chautuoivui@gmail.com");

            BodyBuilder bodyBuilder = new BodyBuilder();
            bodyBuilder.TextBody = content;
            // Title mail before send
            ...
            client.Authenticate("liamchau3006@gmail.com", "vfkd mdwu dphf sqpb");
